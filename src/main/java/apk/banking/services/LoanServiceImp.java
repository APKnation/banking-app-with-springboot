...
public class LoanServiceImp implements LoanService {
    ...
    public Loan approveLoan(Long loanId) {
        ...
        // Record transaction
        transactionRepository.save(new Transaction(null, account.getId(), account.getAccountOwnerName(), "LOAN_DISBURSEMENT", loan.getPrincipalAmount(), account.getBalance(), "COMPLETED", LocalDateTime.now()));
    ...
    public Loan makeRepayment(Long loanId, double amount) {
        ...
        // Record transaction
        transactionRepository.save(new Transaction(null, account.getId(), account.getAccountOwnerName(), "LOAN_REPAYMENT", amount, account.getBalance(), "COMPLETED", LocalDateTime.now()));
